...
otcdocs_repo_name = 'opentelekomcloud-docs/business-continuity-center'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/business-continuity-center/api-ref/'
otcdocs_doc_title = 'API Reference'
otcdocs_doc_type = 'api-ref'
otcdocs_service_category = 'storage'
otcdocs_service_title = 'Business Continuity Center'
otcdocs_service_type = 'bcc'
...
html_title = "Business Continuity Center - API Reference"
...
latex_documents = [
    ('index',
     'bcc-api-ref.tex',
    u'Business Continuity Center - API Reference',
